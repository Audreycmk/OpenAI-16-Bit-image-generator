  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center text-sm text-gray-600">
        <p>The result is generated by <b>OpenAI GPT-4</b> and is abstract—play with it for fun!</p>
        <p>Press Enter or click &quot;Generate Pixel&quot; to add pixels one by one</p>
        <p>Each pixel art is an abstract creation by OpenAI AI—see what it comes up with!</p>
      </div>
    </div>
  );
} 